    ...
    Private Sub btn_insert_repair_Click(sender As Object, e As EventArgs) Handles btn_insert_repair.Click
        ...
        Else
            ...
            With com
                ...
                .CommandText = "INSERT INTO cus_repair value (@id,@repair_id, @cus_name, @shop_name, @address, @tell, @email, @tax_id, @topic, @price, 
@repair_details, @repair_status, @remark, @emp,@emp_edit,NOW(),NOW(),@date_send_cus)"

                .Parameters.Clear()
                .Parameters.Add("@id", MySqlDbType.VarChar).Value = ""
