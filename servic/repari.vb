...
Public Class repari
        ...
        If dr_A.HasRows = True Then
            ...
            While dr_A.Read
                Select Case dr_A("repair_status")
                    Case "0"
                        '    status_show = "รอซ่อม"
                        data_table.Rows(data_table.Rows.Count - 1).DefaultCellStyle.BackColor = Color.Red
                    Case "1"
                        status_show = "เช็คอาการ"
                    Case "2"
                        status_show = "รออะไหล่"
    ...
    Private Sub data_table_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles data_table.CellFormatting
