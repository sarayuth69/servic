...
Public Class show_data_repari
    ...
    Public Sub showData()
        ...
        If dr_A.HasRows = True Then
            ...
            While dr_A.Read
                ...
                End Select
                dtb_equipment.Rows.Add(dr_A("repair_id"), dr_A("cus_name"), dr_A("shop_name"), dr_A("address"), dr_A("tell"), dr_A("email") _
    ...
    Public Sub search()
        ...
        com_A.Connection = con_db
        com_A.CommandType = CommandType.Text
        com_A.CommandText = "SELECT * FROM `cus_repair` WHERE repair_id LIKE '%" & check_text(text_search.Text.Trim) & "%' OR cus_name LIKE '%" & check_text(text_search.Text.Trim) & "%' OR shop_name LIKE '%" & check_text(text_search.Text.Trim) & "%'
                                OR emp LIKE '%" & check_text(text_search.Text.Trim) & "%'"
        dr_A = com_A.ExecuteReader()
    ...
    Private Sub data_table_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles data_table.CellDoubleClick
